 ...
 * Auteurs : - Lyna Kettani, 2124257
             ...
             - Emilia Rus, 2220849
 * Cours inf1995
 * \fichier   MemoireExterne.cpp
 * \date   12 mars 2023

 * Cette classe a pour but le controle d'une ressource interne de l'AVR, la mémoire EEPROM qui stock les données et les garde meme 
 apres coupure de courant.
